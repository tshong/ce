...
let jexcel = (function(el, options) {
    ...
    // todo: key right to avoid readonly cell
...
// console.log('selectedCell', obj.selectedCell)
        obj.updateSelectionFromCoords(obj.selectedCell[0], obj.selectedCell[1], obj.selectedCell[2], obj.selectedCell[3]);
        obj.updateScroll(2);
    }
    ...
    obj.right.visible = function(group, direction) {
        ...
        if (group === 0) {
            // obj.records[x][y].classList.contains('readonly')
            console.log('obj.records, x, y', x, y )
            console.log('obj.records', obj.records[y][x] )
            if (obj.records[y][x].classList.contains('x-label') === true ) {
                x+=1
            }
            obj.selectedCell[0] = x; // control activate x-axis
            obj.selectedCell[1] = y;
        } else {
            obj.selectedCell[2] = x;
            obj.selectedCell[3] = y;
